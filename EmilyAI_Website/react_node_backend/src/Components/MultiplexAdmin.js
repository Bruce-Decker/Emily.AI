            ...
            .then( (response) => {
                ...
                if( response.data.errorMsg !== '' ) {
                    ...
                    swal({
                        type: 'success',
                        title: 'Create Admin',
                        text: 'EmilyAI Admin Created Successfully',
                    })
                    this.setState({
                        first_name: "",
                        last_name: "",
    ...
    render() {
        return(
            <div >
                <div class="row">
                    <div class="col-lg-2">
                        <h4 class="c-grey-900 mB-20">All EmilyAI Admins</h4>
                    </div>
                    <div class="col-lg-10">
                    <div id = "search_bar">
                        <div class="input-group">
                        <input type="text" class="form-control" placeholder="Search EmilyAI Admin By Name" onChange = {this.handleSearchBar.bind(this)}/>
                        </div>
                    </div>
                    </div>
                </div>
                ...
                <div>
                    <div>
                        <hr class='mt-5 mb-5' />
                        <h3>{this.state.update ? 'Update' : 'Add New'} EmilyAI Admin</h3>
                        <hr />
