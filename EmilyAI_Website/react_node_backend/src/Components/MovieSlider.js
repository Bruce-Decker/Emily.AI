...
class Layout extends Component {
  ...
  render() {
    ...
    <div>
      ...
      <div id = "images-divs">
        <img class="" src={require('../assets/static_images/center30.png')} border="0"/>
        <img class="" src={require('../assets/static_images/center31.png')} border="0"/>
        <img class="" src={require('../assets/static_images/center32.png')} border="0"/>
      </div>
      <br/>
      <br/>
      <br/>
