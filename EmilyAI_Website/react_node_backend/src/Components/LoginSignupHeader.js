...
class LoginSignupHeader extends Component {
  ...
  render() {
      ...
      if(this.props.page === "login") {
          changeButtons = (
              <a href="/signup" class = "form-btn btn-sm"> Don't have a Emily AI Account?  <strong> JOIN NOW FOR FREE </strong></a>
          );
      } else if (this.props.page === "signup") {
          changeButtons = (
              <a href="/login" class = "form-btn btn-sm"> Already have a Emily AI Account? <strong> SIGN IN </strong> </a>
          );
      }
